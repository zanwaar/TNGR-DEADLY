<div>
                    ...
                    <tr>
                        ...
                        <td style="vertical-align:middle;">
                            <div class="btn-group btn-group-sm">
                                ...
                                <a href="#" wire:click.prevent="ubahstatus('{{ $bg->id }}')" class="btn btn-dark btn-sm text-white">Ubah Status</a>
    ...
    <div class="modal fade" id="status" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" wire:ignore.self tabindex="-1" role="dialog" id="modalChoice">
        <div class="modal-dialog modal-lg" role="document">
            <form autocomplete="off" wire:submit.prevent="updatestatus">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="exampleModalLabel">
                            @isset($ts)
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            <label for="exampleFormControlInput1" class="form-label">Status Pembelian</label>
                    ...
                    <div class="modal-footer flex-nowrap p-0">
                        ...
                        <button type="submit" class="btn btn-lg btn-link fs-6 text-decoration-none col-6 m-0 rounded-0 border-end"><strong>Ubah status</strong></button>
                    </div>
                </div>
            </form>
        </div>
...
<script language="JavaScript">
    ...
    var mstatus = new bootstrap.Modal("#status");

    window.addEventListener("show-status", function(event) {
        mstatus.show();
    });
